const positions = [
  {
    ...
    points: [
      ...
      'Designed and supported secure credential management applications and network infrastructure to protect against cyber threats and unauthorized access. Ensured the confidentiality, integrity, and availability of client data.',
      'Built communication networks and data retrieval pipelines from over 1000+ remote endpoints including calibrated devices, instruments and sensors. Performed path study calculations, software / hardware router and radio configurations.',
      'Planned and coordinated the work of team members to achieve organizational goals. Maintained strong relationships with clients and vendors. Provided direct product support. Commissioned new projects.  Installed servers and panels. On 24h on-call rotations.',
    ],
  },
  {
    company: 'Ecommplex Inc',
    position: 'Software Developer ⌨️',
    daterange: '2017 - 2018',
    points: [
      'Developed online experiences using HTML, CSS and JS such as galleries, ecommerce, online reports, whitepapers, interactive JS and Python dashboards, web3 DAPPS, smart contracts..',
      'Collaborated with clients and team to improve user friendly features and flows. Customer service and customer care. ',
    ],
  },
  {
  ...
  },
  {
    ...
    daterange: '2016 - 2016',
    points: [
      'Produced documentation packages for maintenance and development projects',
      'Assisted with the design and development of electrical systems and components',
